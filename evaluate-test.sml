...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* 7, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(TIMES,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* 12, [], [] *) 

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* ~1, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* Stuck, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* 7.0, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(TIMES,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* 12.0, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* ~1.0, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* 0.75, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(R(3.0))),Value(Concrete(N(4))))),[],[]),0));
(* Stuck, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(R(3.0))),Value(Concrete(B(true))))),[],[]),0));
(* Stuck, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(B(false))),Value(Concrete(B(false))))),[],[]),0));
(* Stuck, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(N(3))),
					   Value(VRecord([(Lab("a"),Concrete(N(4)))])))),[],[]),0));
(* Stuck, [], [] *)	

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(Concrete(N(3))),Value(Concrete(R(4.0))))),[],[]),0));
(* Stuck, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		ArithExpr(SUBTRACT,Value(Concrete(N(3))),Value(Concrete(N(4)))),
		ArithExpr(TIMES,Value(Concrete(N(5))),Value(Concrete(N(2)))))),[],[]),0));
(* 9, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		...
		ArithExpr(TIMES,
			...
			ArithExpr(SUBTRACT,Value(Concrete(N(3))),Value(Concrete(N(2))))))),[],[]),0));
(* [(10+4)-(3+-1)] + [(3*4)*(3-2)] => 24, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		...
		ArithExpr(TIMES,
			ArithExpr(TIMES,Value(Concrete(N(3))),Value(Concrete(N(4)))),
			ArithExpr(SUBTRACT,Value(Concrete(N(3))),Value(Concrete(R(2.0))))))),[],[]),0));
(* Stuck, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		...
		ArithExpr(TIMES,
			...
			ArithExpr(SUBTRACT,Value(Concrete(R(3.0))),Value(Concrete(R(2.0))))))),[],[]),0));
(* 24.0, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* true, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS_EQ,Value(Concrete(N(2))),Value(Concrete(N(4))))),[],[]),0));
(* true, [], [] *) 

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(MORE,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* false, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(MORE_EQ,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* false, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,Value(Concrete(N(4))),Value(Concrete(N(4))))),[],[]),0));
(* true, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,Value(Concrete(N(3))),Value(Concrete(N(4))))),[],[]),0));
(* false, [], [] *)	

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* true, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS_EQ,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* true, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(MORE,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* false, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(MORE_EQ,Value(Concrete(R(3.0))),Value(Concrete(R(4.0))))),[],[]),0));
(* false, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,Value(Concrete(R(3.0))),Value(Concrete(N(4))))),[],[]),0));
(* Stuck, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS,Value(Concrete(N(3))),Value(Concrete(B(true))))),[],[]),0));
(* Stuck, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(MORE_EQ,Value(Concrete(B(false))),Value(Concrete(R(3.0))))),[],[]),0));
(* Stuck, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(LESS_EQ,
		...
		ArithExpr(TIMES,
			ArithExpr(PLUS,Value(Concrete(N(3))),Value(Concrete(N(1)))),
			ArithExpr(PLUS,Value(Concrete(N(1))),Value(Concrete(N(1))))))),[],[]),0));
(* true, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,
		Value(VRecord([])),
		Value(VRecord([(Lab("a"),Concrete(N(2)))])))),[],[]),0));
(* Stuck *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,
		...
		Value(VRecord([(Lab("a"),Concrete(N(3))),(Lab("b"),Concrete(B(true)))])))),[],[]),0));
(* true, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,
		Value(VRecord([(Lab("a"),Concrete(N(3))),(Lab("b"),Concrete(B(true)))])),
		Value(VRecord([(Lab("a"),Concrete(N(4))),(Lab("b"),Concrete(B(true)))])))),[],[]),0));
(* false, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,
		...
		Value(VRecord([(Lab("a"),Concrete(N(3))),(Lab("b"),Concrete(B(true))),
					   (Lab("d"),Concrete(N(4))),(Lab("c"),Concrete(B(false)))])))),[],[]),0));
(* true, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,
		...
		Record([(Lab("a"),Value(Concrete(N(3)))),(Lab("b"),Value(Concrete(B(true)))),
				(Lab("d"),Value(Concrete(N(4)))),(Lab("c"),Value(Concrete(B(false))))]))),[],[]),0));
(* true, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	BoolExpr(EQ,Value(Concrete(B(true))),Value(Concrete(B(true))))),[],[]),0));
(* true, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(va'),Value(Concrete(N(4))))),[],[]),0));
(* 5, [v['a]->1], ['a->Int] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(TIMES,Value(va''),Value(Concrete(N(4))))),[],[]),0));
(* 4, [v[''a]->1], [''a->Int] *) 

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(va'''),Value(Concrete(N(4))))),[],[]),0));
(* ~3, [v['''a]->1], ['''a->Int] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(va'),Value(Concrete(N(4))))),[],[]),0));
(* Stuck *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(Concrete(R(3.0))),Value(va'))),[],[]),0));
(* 4.0, [v['a]->1.0], ['a->Real] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(TIMES,Value(va''),Value(Concrete(R(4.0))))),[],[]),0));
(* Stuck *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(Concrete(R(3.0))),Value(va'''))),[],[]),0));
(* 2.0, [v['''a]->1.0], ['''a->Real] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(va'''),Value(Concrete(R(4.0))))),[],[]),0));
(* 0.25, [v['''a]->1.0], ['''a->Real] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(va'),Value(vb'))),[],[]),0));
(* v['''a0 + '''a0], 
  [v['a]->v['''a0], v['b]->v['''a0]],
  ['a->'''a0, 'b->'''a0] *)

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(TIMES,Value(va'),Value(va'))),[],[]),0));
(* v['''a0 * '''a0], 
  [v['a]->v['''a0]], 
  ['a->'''a0] *) 

prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(SUBTRACT,Value(va'),Value(va''))),[],[]),0));
(* v['''a0 - 1],
  [v['a]->v['''a0], v[''a]->1],
  ['a->'''a0,'''a0->Int,''a->Int] *)  
...
prettyPrintConfig(evaluate(Config(Expression(
		ArithExpr(PLUS,
			...
			ArithExpr(PLUS,Value(vc''),Value(vd'')))),[],[]),0));
(* 4,
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(DIVIDE,Value(va'),Value(va'))),[],[]),0));
(* 1.0, 
  [v['a]->1.0], 
  ['a->Real] *)
	
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,Value(va'),Value(va'''))),[],[]),0));
(* v['''a0 + '''a0],
  [v['a]->v['''a0],v['''a]->v['''a0]],
  ['a->'''a0,'''a->'''a0] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		...
		ArithExpr(TIMES,Value(Concrete(N(5))),Value(vb')))),[],[]),0));
(* 2,
  [v['a]->1,v['b]->1]
  ['a->Int,'b->Int] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		ArithExpr(SUBTRACT,Value(va'),Value(Concrete(N(4)))),
		ArithExpr(TIMES,Value(Concrete(N(5))),Value(va')))),[],[]),0));
(* 2, 
  [v['a]->1], 
  ['a->Int] *)
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		ArithExpr(SUBTRACT,Value(va'),Value(vb')), 
 		ArithExpr(TIMES,Value(vc'),Value(vd')))),[],[]),0));
(* v['''a12-'''a12 + '''a12*'''a12], 
...
prettyPrintConfig(evaluate(Config(Expression(
	ArithExpr(PLUS,
		ArithExpr(SUBTRACT,Value(va'),Value(vb')), 
 		ArithExpr(TIMES,Value(va'),Value(vb')))),[],[]),0));
(* v[ '''a17-'''a17 + '''a17*'''a17]
  [v['b] -> v['''a17], v['a] -> v['''a17]]
  ['b -> '''a17, 'a -> '''a17] *)
...
prettyPrintConfig(evaluate(Config(Expression(BoolExpr(EQ,Value(va'''),Value(vb''))),[],[]),0));
	...
	Value(VRecord([(Lab("a"),VRecord([(Lab("1"),va''')])),
				   (Lab("b"),VRecord([(Lab("1"),Concrete(N(5))),
									  (Lab("2"),VRecord([(Lab("x"),Concrete(B(false))),
														 (Lab("y"),vb''')]))]))])),
	Value(VRecord([(Lab("a"),va''),(Lab("b"),vb'')])))),[],[]),0));
(* false,
...
prettyPrintConfig(evaluate(Config(Expression(Record([
	(Lab("a"),Value(Concrete(N(3)))),(Lab("b"),Value(Concrete(R(5.0))))])),[],[]),0));	
(* {a=3,b=5.0}, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(Record([
	(Lab("a"),Value(Concrete(B(true)))),(Lab("b"),Value(Concrete(R(5.0))))])),[],[]),0));	
(* {a=true,b=5.0}, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(Record([
	(Lab("a"),Value(Concrete(B(true)))),
	(Lab("b"),Record([(Lab("1"),Value(Concrete(R(5.0)))),
					  (Lab("2"),Value(VRecord([(Lab("x"),Concrete(B(true))),(Lab("y"),Concrete(B(false)))])))]))])),[],[]),0));	
...
prettyPrintConfig(evaluate(Config(Expression(Record([
	...
	(Lab("d"),Record([(Lab("1"),App(Value(Fun(Var("x"),Int,ArithExpr(TIMES,Variable(Var("x")),Value(Concrete(N(10)))))),
									Condition(Value(Concrete(B(true))),
											  Value(Concrete(N(10))),
											  Value(Concrete(N(20)))))),
					  (Lab("2"),Value(Fun(Var("x"),TFun(Int,Int),App(Variable(Var("x")),Value(Concrete(N(5)))))))]))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Condition(
	Value(Concrete(B(true))),Value(Concrete(N(5))),Value(Concrete(N(2))))),[],[]),0));
(* 5, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(Condition(
	Value(Concrete(B(false))),Value(Concrete(N(5))),Value(Concrete(N(2))))),[],[]),0));
(* 2, [], [] *)
	
prettyPrintConfig(evaluate(Config(Expression(Condition(
	Value(Concrete(B(true))),
	BoolExpr(LESS,Value(Concrete(N(2))),Value(Concrete(N(3)))),
	BoolExpr(MORE,Value(Concrete(N(2))),Value(Concrete(N(3)))))),[],[]),0));
(* true, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(Condition(
	Value(va'''),Value(Concrete(B(true))),Value(Concrete(B(false))))),[],[]),0));
(* Stuck *)
...
prettyPrintConfig(evaluate(Config(Expression(Condition(
	...
	Value(Concrete(N(2))),Value(Concrete(N(3))))),[],[]),0));
(* Stuck *)
...
prettyPrintConfig(evaluate(Config(Expression(Condition(
	...
	Value(Concrete(N(3))),Value(Concrete(N(2))))),[],[]),0));
(* 3, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(Condition(
	Condition(BoolExpr(LESS,Value(Concrete(N(2))),Value(Concrete(N(3)))),
			  Value(va'),
			  BoolExpr(EQ,Value(Concrete(B(true))),Value(Concrete(B(true))))),
	Value(va'),Value(Concrete(B(false))))),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	App(Value(Fun(Var("x"),Int,ArithExpr(TIMES,x,x))),Value(Concrete(N(5)))),
	[(PVar(Var("x")),
	ArithExpr(PLUS,x,Value(Concrete(N(2)))))])),[],[]),0));
(* 27, [], [] *)	

prettyPrintConfig(evaluate(Config(Expression(Case(
	Value(Fun(Var("x"),Int,BoolExpr(LESS,x,Value(Concrete(N(10)))))),
	[(PVar(Var("x")),
	App(x,Value(Concrete(N(5)))))])),[],[]),0));
(* true, [], [] *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PRecord([(Lab("5"),PVar(Var("a"))),(Lab("4"),PVar(Var("b"))),(Lab("3"),PVar(Var("x"))),
	  ...
	  ArithExpr(PLUS,x,ArithExpr(PLUS,y,ArithExpr(PLUS,z,ArithExpr(PLUS,a,b)))))])),[],[]),0));
(* 20, [], [...] *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(x1y2,
	  BoolExpr(EQ,BoolExpr(EQ,x,x),y))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
  ...
  [(x1y2,
	Record([(Lab("x"),ArithExpr(PLUS,x,y)),(Lab("y"),ArithExpr(SUBTRACT,x,y))]))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	ArithExpr(PLUS,
			  ...
			  ArithExpr(PLUS,
						...
						Case(z,[(PRecord([]),Value(Concrete(N(4))))]))))])),[],[]),0));
(* 10, [v['a] -> true], [...] *)
	...
	ArithExpr(TIMES,
			  ...
			  Case(Record([(Lab("1"),Value(Concrete(N(3)))),(Lab("2"),y),(Lab("3"),z)]),
			     [(PRecord([(Lab("3"),PVar(Var("c"))),(Lab("1"),PVal(N(3))),(Lab("2"),PVar(Var("b")))]),
				   ArithExpr(TIMES,Variable(Var("c")),ArithExpr(TIMES,b,Value(Concrete(N(3))))))])))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	ArithExpr(PLUS,
			  ...
			  Case(Record([(Lab("1"),Value(vc''')),(Lab("2"),y)]),
			       [(a1b2,ArithExpr(TIMES,a,ArithExpr(TIMES,b,Value(vd'''))))])))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	Case(Record([(Lab("a"),ArithExpr(PLUS,x,y)),
		 ...
		 Record([(Lab("x"),ArithExpr(TIMES,x,a)),(Lab("y"),ArithExpr(TIMES,z,y))]))]))])),[],[]),0));
(* {x=105,y=96}, ... *)
...
prettyPrintConfig(evaluate(Config(Expression(Value(
	Fun(Var("x"),Int,ArithExpr(PLUS,x,x)))),[],[]),0));
(* fn x:int => x+x, [], [] *)

prettyPrintConfig(evaluate(Config(Expression(Value(
	Fun(Var("x"),Int,
		Value(Fun(Var("y"),Int,ArithExpr(PLUS,y,x)))))),[],[]),0));
		 ...
		 Value(Fun(Var("y"),Int,
			   Value(Fun(Var("z"),Int,
					 Value(Fun(Var("a"),Int,
						   Value(Fun(Var("b"),Int,
	ArithExpr(PLUS,x,ArithExpr(PLUS,y,ArithExpr(PLUS,z,ArithExpr(PLUS,a,b)))))))))))))),
	Value(Concrete(N(2)))),Value(Concrete(N(3)))),Value(Concrete(N(4))))),[],[]),0));
		 ...
		 Value(Fun(Var("y"),Int,
			   Value(Fun(Var("z"),Int,
					 Value(Fun(Var("a"),Int,
						   Value(Fun(Var("b"),Int,
	ArithExpr(PLUS,x,ArithExpr(PLUS,y,ArithExpr(PLUS,z,ArithExpr(PLUS,a,b)))))))))))))),
	Value(Concrete(N(2)))),Value(Concrete(N(3)))),Value(Concrete(N(4)))),Value(Concrete(N(5))))),[],[]),0));
 (* fn b:int => 2+3+4+5+b *)
		 ...
		 Value(Fun(Var("y"),Int,
			   Value(Fun(Var("z"),Int,
					 Value(Fun(Var("a"),Int,
						   Value(Fun(Var("b"),Int,
	ArithExpr(PLUS,x,ArithExpr(PLUS,y,ArithExpr(PLUS,z,ArithExpr(PLUS,a,b)))))))))))))),
	Value(Concrete(N(2)))),Value(Concrete(N(3)))),Value(Concrete(N(4)))),Value(Concrete(N(5)))),Value(Concrete(N(6))))),[],[]),0));
 (* 20 *)
...
prettyPrintConfig(evaluate(Config(Expression(App(
	...
	Value(VRecord([(Lab("1"),Concrete(N(3))),(Lab("2"),Concrete(N(7)))])))),[],[]),0));
(* 10 *)
...
prettyPrintConfig(evaluate(Config(Expression(App(App(
	...
	Value(VRecord([(Lab("1"),Concrete(N(0))),(Lab("2"),Concrete(N(10)))])))),[],[]),0));
(* 0, [...] *)
...
prettyPrintConfig(evaluate(Config(Expression(App(App(
	...
	Condition(Value(vg'),
			  ...
			  Value(VRecord([(Lab("1"),vc'),(Lab("2"),vc')]))))),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(App(
	...
	App(Value(Fun(Var("x"),Real,ArithExpr(PLUS,x,x))),
		Condition(Value(va'),
				  Value(Concrete(R(2.0))),Value(Concrete(R(4.0))))))),[],[]),0));
(* 8.0 *)
...
prettyPrintConfig(evaluate(Config(Expression(App(
	...
	App(Value(Fun(Var("x"),Real,ArithExpr(PLUS,x,x))),
		Condition(Value(Concrete(B(false))),
				  Value(Concrete(N(2))),Value(Concrete(R(4.0))))))),[],[]),0));
(* Stuck *)

prettyPrintConfig(evaluate(Config(Expression(App(
	Value(va'),Value(Concrete(N(2))))),[],[]),0));
(* v['a1236],
...
prettyPrintConfig(evaluate(Config(Expression(App(App(
	Value(va'),Value(Concrete(N(2)))),Value(Concrete(N(2))))),[],[]),0));
(* v['a1272],
 ...
 prettyPrintConfig(evaluate(Config(Expression(App(
	...
	Value(Fun(Var("y"),THole(TypeHole(EqualityTypeVar("a"))),
			   Condition(Value(va''),
						 ...
						 Value(Fun(Var("x"),TRecord([(Lab("1"),Int),(Lab("2"),Int)]),
									Case(x,[(x1y2,ArithExpr(SUBTRACT,x,y))])))))))),[],[]),0));
(* v['a1747],
	...
	Value(Fun(Var("y"),THole(TypeHole(EqualityTypeVar("a"))),
			   Condition(Value(va''),
						 ...
						 Value(Fun(Var("x"),TRecord([(Lab("1"),Real),(Lab("2"),Real)]),
									Case(x,[(x1y2,ArithExpr(DIVIDE,x,y))])))))))),[],[]),0));
(* Stuck *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(N(0)),Value(Concrete(B(true)))),
	 ...
	 (PVal(N(1)),Value(Concrete(B(false))))])),[],[]),0));
(* false *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(N(0)),Value(Concrete(B(true)))),
	 (PVal(N(2)),Value(Concrete(B(true)))),
	 (PWildcard,Value(Concrete(B(false))))])),[],[]),0));	 
(* false *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(N(0)),Value(Concrete(B(true)))),
	 (PVal(N(2)),Value(Concrete(B(true)))),
	 (PVar(Var("x")),Value(Concrete(N(1))))])),[],[]),0));
(* Stuck *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(N(0)),Value(Concrete(B(true)))),
	 (PVal(N(2)),Value(Concrete(B(true)))),
	 (PVar(Var("x")),Value(Concrete(B(false))))])),[],[]),0));
(* false *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PRecord([(Lab("a"),PVal(N(0))),(Lab("b"),PVal(N(0)))]),Value(Concrete(N(0)))),
	 ...
	 (PRecord([(Lab("b"),PVar(Var("x"))),(Lab("a"),PVar(Var("y")))]),
	  ArithExpr(TIMES,Variable(Var("x")),Variable(Var("y"))))])),[],[]),0));
(* 2 *)
	...
	[(PRecord([(Lab("a"),PVal(N(0))),(Lab("b"),PWildcard),(Lab("c"),PRecord([(Lab("1"),PVal(N(0)))])),
	 ...
	 (PRecord([(Lab("a"),PVal(N(2))),(Lab("b"),PVar(Var("f1"))),(Lab("c"),PRecord([(Lab("1"),PVal(N(0)))])),
	  ...
	  ArithExpr(TIMES,App(Variable(Var("f2")),Value(Concrete(B(false)))),
					  App(Variable(Var("f1")),Value(Concrete(N(3))))))])),[],[]),0));
(* -9 *)
	...
	[(PRecord([(Lab("a"),PVal(N(16))),(Lab("b"),PWildcard),(Lab("c"),PRecord([(Lab("1"),PRecord([]))])),
	  ...
	  Case(Variable(Var("y")),
		  [(PRecord([(Lab("i"),PVar(Var("val"))),(Lab("k"),PWildcard),(Lab("j"),PWildcard),
			...
			App(Variable(Var("x")),Variable(Var("val"))))]))])),[],[]),0));
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(EmptyList),Value(Concrete(N(1)))),
	 (PCons(PVar(Var("x")),PVar(Var("y"))),Value(Concrete(N(2))))])),[],[]),0));
(* 2 *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
	...
	[(PVal(EmptyList),Value(Concrete(N(0)))),
	 ...
	 (PCons(PVal(N(1)),PCons(PVal(N(2)),PCons(PVal(N(3)),PVar(Var("x"))))),Value(Concrete(N(6))))])),[],[]),0));
(* 6 *)
...
prettyPrintConfig(evaluate(Config(Expression(Case(
  ...
  [(PVal(EmptyList),Value(VRecord([(Lab("a"),Concrete(N(~1))),(Lab("b"),Concrete(EmptyList))]))),
   (PCons(PVar(Var("x")),PVar(Var("y"))),Record([(Lab("a"),Variable(Var("x"))),(Lab("b"),Variable(Var("y")))]))])),[],[]),0));
(* {a=6, b=[16,10]} *)
 ...
 prettyPrintConfig(evaluate(Config(Expression(LetRec(
	...
	App(App(Variable(Var("filter")),
		...
		Value(VList([Concrete(N(1)),Concrete(N(10)),Concrete(N(10)),
					 Concrete(N(5)),Concrete(N(10)),Concrete(N(5))]))))),[],[]),0));
(* filter: [10,10,10] *)
